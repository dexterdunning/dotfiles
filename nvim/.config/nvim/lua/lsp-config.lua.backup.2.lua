...
-- Configure basedpyright for fast Python LSP with inlay hints
vim.lsp.config('basedpyright', {
	...
	settings = {
		basedpyright = {
			...
			analysis = {
				-- Key performance setting: only analyze open files
				diagnosticMode = "openFilesOnly", -- Much faster for large projects
				autoSearchPaths = true,
				useLibraryCodeForTypes = true,
				
				-- Inlay hints configuration (better than pylsp)
				inlayHints = {
					variableTypes = true,
					...
					functionReturnValues = false, -- Can be noisy
				},
				...
				-- Basedpyright specific optimizations for large codebases
				reportAny = false, -- Can be very noisy in large codebases
	...
	on_attach = function(client, bufnr)
		...
		-- Organize imports (basedpyright specific)
		vim.keymap.set("n", "<leader>oi", function()
			vim.lsp.buf.code_action({
				filter = function(action)
					return action.title:find("Organize Imports")
				end,
				apply = true,
			})
		end, opts)
